...
function RetrievePasword() {
  return (
    <div className="retrieve-password-background-b contiane-fluid">
      ...
      <div className="container shadow-lg bg-body broker-login col-7 bg-light">
        <div className="text-center"><img alt="" className="user-image" src={lock} /></div>
          <form>
...
export default RetrievePasword;
